(function (factory) {
  ...
  const katexJSURL = '/anthropic-serve/katex/katex.min.js';
  const katexCSSTag = '<link rel="stylesheet" href="/anthropic-serve/katex/katex.min.css" crossorigin="anonymous">';
