...
![SCC overview](assets/scc_overview_gemma3_1b_it.png)

### 指定 SAE features 跨 SCC 与 persona 曲线

![Selected SAE feature curves](assets/scc_selected_sae_feature_curves.png)

### Feature 2000：低 SCC 的“我作为LLM”增强

![Feature 2000 focus](assets/scc_feature_2000_llm_focus_inverted.png)

### SAE 梯度 feature 热图

![SAE gradient features](assets/scc_sae_gradient_features.png)

相关文件：

- `assets/scc_overview_gemma3_1b_it.png`：SCC 轴投影、raw norm、组间距离总览。
- `assets/scc_selected_sae_feature_curves.png`：指定 SAE features 跨 SCC 与 persona 的曲线。
- `assets/scc_feature_2000_llm_focus_inverted.png`：feature 2000 在“我作为LLM”中的低 SCC 增强。
- `assets/scc_sae_gradient_features.png`：SAE 梯度相关 features。
- `results/self_concept_clarity_1b_it/sae_group_contrasts.md`：SAE 组间 contrast 分解表。
